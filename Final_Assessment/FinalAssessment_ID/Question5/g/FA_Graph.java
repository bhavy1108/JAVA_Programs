...
public class FA_Graph 
{
    ...
    /* read graph fom file*/ 
    /* Reference practical 6 graph - semester 1 2020*/
 ...
 FA_Graph g = new FA_Graph(t + 1);
  ...
  try
  {
   ...
   while (line != null)
   {
     ...
     char A = token[0].charAt(0);
     char B = token[1].charAt(0);
     g.addEdge(A,B);
